...
public partial class GenerationPage : ContentPage
{
    ...
    private void OnDeclineButton_Clicked(object sender, EventArgs e)
    {
        ...
        // Show the Editor for editing the prompt
        EditedPromptEditor.IsVisible = true;

        // Set the text of the Editor to the generated prompt
        EditedPromptEditor.Text = GeneratedPromptTextBlock.Text;

        // Optionally, set focus on the Editor so the user can start editing immediately
    ...
    {
        string promptToUse = EditedPromptEditor.IsVisible ? EditedPromptEditor.Text : GeneratedPromptTextBlock.Text; 
